...
def main():
    ...
    try:
        ...
        matrix1 = SparseMatrix(filePath="dsa/sparse_matrix/sample_inputs/matrixfile1.txt")
        matrix2 = SparseMatrix(filePath="dsa/sparse_matrix/sample_inputs/matrixfile3.txt")

        # Perform the selected operation
        if choice == 1:
            result = matrix1 + matrix2
            output_file = "dsa/sparse_matrix/sample_inputs/result_add.txt"
        elif choice == 2:
            result = matrix1 - matrix2
            output_file = "dsa/sparse_matrix/sample_inputs/result_sub.txt"
        elif choice == 3:
            result = matrix1 * matrix2
            output_file = "dsa/sparse_matrix/sample_inputs/result_mul.txt"
